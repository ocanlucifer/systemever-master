<?php namespace App\Http\Controllers;
	...
	class AdminTestimoniesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Photo','name'=>'photo','type'=>'upload','validation'=>'required|image','width'=>'col-sm-10','help'=>'File types support : JPG, JPEG, PNG, GIF, BMP'];
			...
			$this->form[] = ['label'=>'Job Title','name'=>'job_title','type'=>'text','validation'=>'required','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Featured Image','name'=>'featured_image','type'=>'upload','validation'=>'required|image','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Job Title","name"=>"job_title","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
