<?php namespace App\Http\Controllers;
	...
	class AdminCeoForumsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ['label'=>'Title','name'=>'title','type'=>'text','validation'=>'required|string|min:3|max:100','width'=>'col-sm-10','placeholder'=>'You can only enter the letter only'];
			//$this->form[] = ['label'=>'Post Date','name'=>'post_date','type'=>'date','validation'=>'required|date','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Image Url','name'=>'image_url','type'=>'upload','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Slider Title','name'=>'slider_title','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Video Link','name'=>'video_link','type'=>'text','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Presenter','name'=>'presenter','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-9'];
			//$this->form[] = ['label'=>'Body','name'=>'body','type'=>'wysiwyg','validation'=>'required|string|min:5|max:500000','width'=>'col-sm-10','dataenum'=>'ID;EN;KOR;'];
			//// $this->form[] = ['label'=>'Lang','name'=>'lang','type'=>'select2','validation'=>'required','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Lang','name'=>'lang','type'=>'select2','validation'=>'required','width'=>'col-sm-10','dataenum'=>'ID;EN;KOR;'];
			# OLD END FORM
	    ...
	    */
	    public function hook_after_edit($id) {
            ...
            // Hapus field yang tidak ingin masuk log
            unset($postdata['body']);
	    }
