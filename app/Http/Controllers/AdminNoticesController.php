<?php namespace App\Http\Controllers;
	...
	class AdminNoticesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Date Start","name"=>"date_start"];
			$this->col[] = ["label"=>"Date End","name"=>"date_end"];
			...
			$this->form[] = ['label'=>'URL','name'=>'url','type'=>'text','validation'=>'','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Desc','name'=>'desc','type'=>'wysiwyg','validation'=>'required','width'=>'col-sm-10'];
			// $this->form[] = ['label'=>'Views','name'=>'views','type'=>'number','validation'=>'required','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Author','name'=>'author','type'=>'text','validation'=>'required','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Date Start','name'=>'date_start','type'=>'date','validation'=>'required','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Date End','name'=>'date_end','type'=>'date','validation'=>'required','width'=>'col-sm-10'];
			// $this->form[] = ['label'=>'Date End','name'=>'date_end','type'=>'date','validation'=>'required','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Date Start","name"=>"date_start","type"=>"date","required"=>TRUE,"validation"=>"required|date"];
			//$this->form[] = ["label"=>"Date End","name"=>"date_end","type"=>"date","required"=>TRUE,"validation"=>"required|date"];
			# OLD END FORM
