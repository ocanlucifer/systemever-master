<?php namespace App\Http\Controllers;
	...
	class AdminHomesettingController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
	        ...
	        */
	        ...
	        |
	        */
	        $this->pre_index_html = '<script>window.location = "'.CRUDBooster::mainpath().'/setting"; </script>';
	    ...
	    */
		...
		{
			return view("admin/form/home_setting");
		}
	}