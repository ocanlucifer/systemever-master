<?php namespace App\Http\Controllers;
	...
	class AdminLegalPagesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			// $this->form[] = ["label"=>"Seo Meta","name"=>"body","type"=>"custom","html"=> view('admin/form/seo', ['type' => 'legal'])];
