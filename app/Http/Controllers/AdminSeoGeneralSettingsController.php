<?php namespace App\Http\Controllers;
	...
	class AdminSeoGeneralSettingsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Setting','name'=>'key','type'=>'text','validation'=>'required','width'=>'col-sm-6','readonly' => true];
	    ...
	    */
	    public function hook_query_index(&$query) {
			...
			$query->where("setting_type" , "seo_general");
	    ...
	    */
	    public function hook_before_add(&$postdata) {        
	        //Your code here
			$postdata['setting_type'] = 'seo_general';
