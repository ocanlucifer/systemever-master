<?php namespace App\Http\Controllers;
	...
	class AdminProductJourneysController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Body','name'=>'body','type'=>'textarea','validation'=>'required','width'=>'col-sm-10'];
