<?php namespace App\Http\Controllers;
	...
	class AdminAboutUsHistoriesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Body","name"=>"body", "callback" => function($row){
				return preg_replace("/<([a-z][a-z0-9]*)[^>]*?(\/?)>/si",'<$1$2>', $row->body);
			}];
			...
			$this->form[] = ['label'=>'Year','name'=>'year','type'=>'number','validation'=>'required','width'=>'col-sm-10', 'min' => 1980, 'max' => date("Y")];
			$bulan = "";
			for ($i = 1; $i <= 12; $i++) {
				$bulan .= $i . "|" . bulan_str($i) . ";";
			}
			$this->form[] = ['label'=>'Month','name'=>'month','type'=>'select2','validation'=>'required','width'=>'col-sm-10', 'dataenum' => $bulan];
