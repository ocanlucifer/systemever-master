<?php namespace App\Http\Controllers;
	...
	class AdminVideosController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Video Categories Id","name"=>"video_categories_id","join"=>"video_categories,name"];
			$this->col[] = ["label"=>"Lang","name"=>"lang"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Youtube','name'=>'youtube','type'=>'text','validation'=>'required','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Video Categories Id','name'=>'video_categories_id','type'=>'select2','validation'=>'required','width'=>'col-sm-10','datatable'=>'video_categories,name'];
