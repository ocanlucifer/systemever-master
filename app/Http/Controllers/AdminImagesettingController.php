<?php namespace App\Http\Controllers;
	...
	class AdminImagesettingController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Image","name"=>"value","image"=>true];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Key','name'=>'key','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Value','name'=>'value','type'=>'filemanager','validation'=>'required','width'=>'col-sm-10'];
	    ...
	    */
	    public function hook_query_index(&$query) {
			...
			$query->whereRaw($this->table . ".setting_type = 'image'");
	    }
