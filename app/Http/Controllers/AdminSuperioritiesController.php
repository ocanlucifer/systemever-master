<?php namespace App\Http\Controllers;
	...
	class AdminSuperioritiesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "superiorities";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Icon","name"=>"icon", "callback" => function($row){
				$url = uri($row->icon);
	        ...
	        */
	        ...
	        |
	        */
	        $this->pre_index_html = (string)view("admin/form/youtube");
