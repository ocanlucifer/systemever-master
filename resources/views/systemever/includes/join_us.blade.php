<section class="section-consultant mb-5">
    <div class="container-content">
        <div class="row">
            <div class="col-lg-6 box-img-consult join-us position-relative">
            ...
            <div class="col-lg-6 d-flex align-items-center justify-content-center">
                <div class="title-form-consultant py-5">
                    <h5>{{ stringlang('We are hiring now', 'Kami sedang mencari mitra') }}</h5>
                    <h3>{{ stringlang('Become Our Partner', 'Jadilah Mitra Kami') }}<br>{{ stringlang('to get special offers!', 'untuk mendapatkan penawaran special!') }}</h3>
                    ...
                    <a href=""><button type="button" class="btn-oval btn-view-detail btn-contact-us btn-white-orange mt-3">{{ stringlang('Join Us', 'Gabung Sekarang') }}</button></a>
                </div>
            </div>
        </div>
    </div>
