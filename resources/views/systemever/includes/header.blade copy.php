    ...
    <div class="container-content">
      <div class="row d-flex align-items-center">
        <div class="col-lg-8">
          {{-- {{seeinindo()}} --}}
          @if (activelang() == "EN")
          Learn how SystemEver fits perfectly into your remote work trip. <a href="{{ route('get.pages.support.video') }}"><b> Watch Tutorial Video.</b></a>&nbsp;<i class="fa fa-arrow-right"></i>
          @else 
          Pelajari lebih lanjut bagaimana SystemEver sangat tepat untuk bekerja remote <a href="{{ route('get.pages.support.video') }}"><b> Lihat Video Tutorial.</b></a>&nbsp;<i class="fa fa-arrow-right"></i>
          @endif
        </div>
        <div class="col-lg-4">
              ...
              <div class="dropdown dropdown-language">
                <button class="btn d-flex align-items-center" type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <div id="EN" class="lang {{ activelang() == "EN" ? 'active' : '' }}">
                    {{-- ENG --}}
                    <img src="{{ asset('assets/img/english-icon.png')}}" style="height:20px;">
                  </div>
                  <div id="ID" class="lang {{ activelang() == "ID" ? 'active' : '' }}">
                    <img src="{{ asset('assets/img/indonesia-icon.png')}}" style="height:20px;">
                  </div>
        ...
        <div class="col-lg-10 d-flex justify-content-end">
          <ul class="mb-0 list-unstyled d-flex justify-content-end align-items-center">
            <li id="about" class="dropdown-header">
              <a href="{{ route('get.pages.abouts.indonesia_branch') }}" class="{{ Request::segment(1) == 'about' ? 'active':'' }}">{{ stringlang('About', 'Tentang Kami') }}</a>
            ...
            <li id="solutions" class="dropdown-header">
              <a href="{{ route('get.pages.solutions.index') }}" class="{{ Request::segment(1) == 'solutions' ? 'active':'' }}">{{ stringlang('Solution', 'Solusi') }}</a>
              <div class="dropdown-menu-header py-4 px-4">
                  <div class="segitiga">
                    <img src="{{ asset('assets/img/Rectangle.svg') }}" alt="">
                  </div>
                  <div class="isimenu pl-0 pr-4">
                    <ul class="list-unstyled menu-drop">
                      <li>{{ stringlang('Solution', 'Solusi') }}</li>
                      <li class="{{ Request::segment(2) == 'account-tax' ? 'active':'' }}">
                        <a onclick="imgControl('2')" href="{{ route('get.pages.solutions.index') }}">{{ stringlang('AccounTax', 'Layanan Akuntansi & Pajak') }}</a>
                        <div class="img-menu img-menu-1">
                          <img src="{{ asset('assets/img/img-erp1.png') }}" alt="">
                        </div>
                      </li>
                      <li class="{{ Request::segment(2) == 'bms' ? 'active':'' }}">
                        <a onclick="imgControl('2')" href="{{ route('get.pages.solutions.bms') }}">{{ stringlang('SystemEver BMS', ' SystemEver BMS') }}</a>
                        <div class="img-menu img-menu-2">
                          <img src="{{ asset('assets/img/img-erp2.png') }}" alt="">
                        </div>
                      </li>
                      {{-- <li class="{{ Request::segment(2) == 'i7-manufacture' ? 'active':'' }}">
                        <a onclick="imgControl('2')" href="{{ route('get.pages.solutions.i7_manufacture') }}">{{ stringlang('Integrated Manufacturing', 'Manufaktur Terintegrasi') }}</a>
                        <div class="img-menu img-menu-3">
                  ...
                  <div class="img-menu-drop" id="menu-img-2">
                    <img class="{{ Request::segment(2) == 'accounting-management-systems' ? 'd-none': Request::segment(2) == 'i5-trading' ? 'd-none': Request::segment(2) == 'i7-manufacture' ? 'd-none':''}}" src="{{ asset('assets/img/img-erp1.png') }}" alt="">
                  </div>
              </div>
            </li>
            <li id="service" class="dropdown-header">
              <a href="{{ route('get.pages.services.feature') }}" class="{{ Request::segment(1) == 'service' ? 'active':'' }}">{{ stringlang('Service', 'Layanan') }}</a>
              <div class="dropdown-menu-header py-4 px-4">
                  <div class="segitiga">
                    <img src="{{ asset('assets/img/Rectangle.svg') }}" alt="">
                  </div>
            ...
            <li id="support" class="dropdown-header">
              <a href="{{ route('get.pages.support.video') }}" class="{{ Request::segment(1) == 'support' ? 'active':'' }}">{{ stringlang('Support', 'Dukungan') }}</a>
            ...
            <li id="article" class="dropdown-header">
              <a href="{{ route('get.pages.article.professional') }}" class="{{ Request::segment(1) == 'business-insight' ? 'active':'' }}">{{ stringlang('Business Insight', 'Business Insight') }}</a>
              <div class="dropdown-menu-header py-4 px-4 ">
                  <div class="segitiga">
                    <img src="{{ asset('assets/img/Rectangle.svg') }}" alt="">
                  </div>
    ...
    <div class="container-content">
      <div class="row">
        <div class="col-lg-12 d-flex justify-content-between align-items-center">
          ...
          <ul class="list-unstyled mb-0 d-flex align-items-center justify-content-end">
            <li class="mr-1"><a href="{{ route('get.contact') }}" class="button btn-black-green-demo btn-rounded">
              @if (activelang() == "EN")
              FREE&nbsp;DEMO
              @else 
              DEMO&nbsp;GRATIS
            ...
            {{-- <li class="mr-1"><button class="button btn-black-green-demo btn-rounded" data-toggle="modal" data-target="#modal-request-demo">FREE DEMO</button></li> --}}
            <li><a href="{{ route('get.pages.join_partnership') }}"><button class="button btn-black-green-demo btn-rounded">
              @if (activelang() == "EN")
              BECOME&nbsp;A&nbsp;PARTNER  
              @else 
              MENJADI&nbsp;MITRA
