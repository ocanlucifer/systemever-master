...
<section class="py-8 lg:py-16">
    <div class="container">
        <div class="bc"><a href="/">{{ stringlang('Home', 'Beranda') }}</a><img src="{{asset('assets/fl/bc.png')}}" alt=""><a href="">{{ stringlang('Solution', 'Solusi') }}</a><img src="{{asset('assets/fl/bc.png')}}" alt=""><a href="" class="active">AccountTax</a></div>
        <div class="flex flex-col-reverse lg:flex-row items-center "  >
            <div class="w-full lg:w-1/2 flex flex-col gap-5 lg:gap-8 lg:pr-20">
                ...
                <div class="flex mt-2 lg:mt-4 justify-center lg:justify-start">
                    <a href="{{ ordefault($meta->demo_url, '#') }}" class="font-montserrat lg:text-16px text-11px inline-flex items-center justify-center h-30px lg:h-48px lg:px-30px px-4  rounded-full bg-[#009944] text-white font-bold mr-4 hover:text-white">
                        {{ ordefault($meta->demo_label, 'Jadwalkan Demo') }}
                    </a>
                    <a href="{{ ordefault($meta->see_more_url, '#') }}" class="font-montserrat lg:text-16px text-11px inline-flex items-center justify-center h-30px lg:h-48px lg:px-50px px-4  rounded-full bg-transparent text-[#009944] font-bold border border-[#009944] hover:text-[#009944]">
...
<section class="pt-8 lg:pt-16" x-data="{current:0}">
    <div class="container pb-5 lg:pb-10">
        <h2 class="text-20px lg:text-27px font-poppins font-medium text-center mb-3 lg:mb-6  leading-6 lg:leading-9">
            {!!  str_replace( "#JadiLebihMudah", "<strong>#JadiLebihMudah</strong>", ordefault($meta->second_section_title, 'Kontrol bisinis #JadiLebihMudah dengan SystemEver'))  !!}
        </h2>
        ...
        <div class="justify-between w-full px-12 mt-16 hidden lg:flex">
            <div class="flex gap-4 items-center p-4 cursor-pointer relative" @click="current=0">
                <img src="{{ uri( ordefault($meta->inventory_main_icon, 'assets/fl/tab-1.png'))}}" alt="" :class="current!=0?'filter grayscale-100':''">
                <span class="font-poppins text-18 font-semibold text-[#01010]">{{ ordefault($meta->inventory_tab_title, 'Inventory multigudan') }}</span>
            ...
            <div class="flex gap-4 items-center p-4 cursor-pointer relative" @click="current=1">
                <img src="{{ uri( ordefault($meta->export_import_feature_main_icon, 'assets/fl/tab-2.png') )}}" alt="" :class="current!=1?'filter grayscale-100':''">
                <span class="font-poppins text-18 font-semibold text-[#01010]">{{ ordefault($meta->export_import_feature_tab_title, 'Eksport Import modul') }}</span>
            ...
            <div class="flex gap-4 items-center p-4 cursor-pointer relative" @click="current=2">
                <img src="{{ uri( ordefault($meta->procurement_feature_main_icon,'assets/fl/tab-4.png'))}}" alt="" :class="current!=2?'filter grayscale-100':''">
                <span class="font-poppins text-18 font-semibold text-[#01010]">{{ ordefault($meta->procurement_feature_tab_title, 'Digitalisasi Procurement') }}</span>
            ...
            <div class="flex gap-4 items-center p-4 cursor-pointer relative" @click="current=3">
                <img src="{{ uri(ordefault($meta->visual_operational_feature_main_icon,'assets/fl/tab-3.png'))}}" alt="" :class="current!=3?'filter grayscale-100':''">
                <span class="font-poppins text-18 font-semibold text-[#01010]">{{ ordefault($meta->visual_operational_feature_tab_title, 'Visualisai operasional secara realtime') }}</span>
            ...
            <div class="container">
                <div class="flex justify-between mb-6 items-center px-4 lg:hidden">
                    ...
                    <div class="flex flex-col items-center gap-2">
                        ...
                        <span class="text-14px font-poppins font-semibold text-center leading-5">{{ ordefault($meta->inventory_tab_title, 'Inventory multigudan') }}</span>
                    </div>
                ...
                <div class="flex lg:flex-row flex-col-reverse gap-4 lg:gap-12">
                    <div class="w-full lg:w-[45%] px-2">
                        <h3 class="text-18px lg:text-27px lg:leading-9 leading-6 font-poppins font-medium mb-4 lg:mb-10">{{ ordefault($meta->inventory_tab_title, 'Inventory multigudan') }}</h3>
                        @if (!empty($meta->inventory_selling_point))
                        @foreach ($meta->inventory_selling_point as $v)
                        <div class="flex gap-3 lg:gap-4 mb-3 lg:mb-8">
                            ...
                            <div>
                                <p class="font-semibold text-12px lg:text-17px font-poppins leading-4 lg:leading-6 mb-1">{{ $v->inventory_selling_point_title }}</p>
                                <p class="text-11px lg:text-17px font-poppins text-[#707070] leading-5 lg:leading-6">
                                    {{ $v->inventory_selling_point_desc }}
                                </p>
                            </div>
                        </div>
                        @endforeach
                        ...
                        {{-- <div class="flex gap-3 lg:gap-4 mb-3 lg:mb-8">
                            <div class="flex-shrink-0  w-5 aspect-square lg:w-auto"><img src="{{ asset('assets/fl/check-flower.png')}}" alt=""></div>
                            <div>
                                <p class="font-semibold text-12px lg:text-17px font-poppins leading-4 lg:leading-6 mb-1">Atur dan pantau stock barang dari mana saja dan kapan saja</p>
                                <p class="text-11px lg:text-17px font-poppins text-[#707070] leading-5 lg:leading-6">
                                    Dapatkan update persediaan barang tanpa harus datang ke gudang</p>
                            </div>
                        </div>
                        <div class="flex gap-4">
                            <div class="flex-shrink-0  w-5 aspect-square lg:w-auto"><img src="{{ asset('assets/fl/check-flower.png')}}" alt=""></div>
                            <div>
                                <p class="font-semibold text-12px lg:text-17px font-poppins leading-4 lg:leading-6 mb-1">Hindari kesalahan perhitungan stock barang</p>
                                <p class="text-11px lg:text-17px font-poppins text-[#707070] leading-5 lg:leading-6">
                                    Dapatkan data beginning stock (stok awal) dan seluruh transaksi, sehingga menghasilkan ending stock (stok akhir) yang akurat berdasarkan periode tertentu sesuai kebijakan perusahaan secara realtime</p>
                            </div>
                        </div> --}}
                    </div>
                    <div class="w-full lg:w-[54%] lg:pt-10 pt-2">
                        <img src="{{ uri( ordefault($meta->inventory_main_image, 'assets/fl/thumb-multi.png'))}}" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="flex justify-between mb-6 items-center px-4 lg:hidden">
                    ...
                    <div class="flex flex-col items-center gap-2">
                        ...
                        <span class="text-14px font-poppins font-semibold text-center leading-5">{{ ordefault($meta->export_import_feature_tab_title, 'Eksport Import modul') }}</span>
                    </div>
                    <img src="{{ asset('assets/fl/tab-arrow.png')}}" alt="" @click="current++">
                </div>
                <div class="flex lg:flex-row flex-col-reverse gap-4 lg:gap-12">
                    <div class="w-full lg:w-[45%] px-2">
                        <h3 class="text-18px lg:text-27px lg:leading-9 leading-6 font-poppins font-medium mb-4 lg:mb-10">{{ ordefault($meta->export_import_feature_tab_title, 'Eksport Import modul') }}</h3>
                        ...
                        {{-- <div class="flex gap-3 lg:gap-4 mb-3 lg:mb-8">
                            <div class="flex-shrink-0  w-5 aspect-square lg:w-auto"><img src="{{ asset('assets/fl/check-flower.png')}}" alt=""></div>
                            <div>
                                <p class="font-semibold text-12px lg:text-17px font-poppins leading-4 lg:leading-6 mb-1">Modul eksport dan import sesuai aturan yang berlaku di berbagai negara</p>
                                <p class="text-11px lg:text-17px font-poppins text-[#707070] leading-5 lg:leading-6">
                                    Hindari kesalahan dalam melakukan eksport import dengan modul yang selalu update dengan regulasi terbaru</p>
                            </div>
                        </div>
                        <div class="flex gap-3 lg:gap-4 mb-3 lg:mb-8">
                            <div class="flex-shrink-0  w-5 aspect-square lg:w-auto"><img src="{{ asset('assets/fl/check-flower.png')}}" alt=""></div>
                            <div>
                                <p class="font-semibold text-12px lg:text-17px font-poppins leading-4 lg:leading-6 mb-1">Terhindar dari
                                    Update proses secara realtime</p>
                                <p class="text-11px lg:text-17px font-poppins text-[#707070] leading-5 lg:leading-6">
                                    Update data dan proses eksport ataupun import secara realtime dalam satu dashboard</p>
                            </div>
                        </div>
                        <div class="flex gap-4">
                            <div class="flex-shrink-0  w-5 aspect-square lg:w-auto"><img src="{{ asset('assets/fl/check-flower.png')}}" alt=""></div>
                            <div>
                                <p class="font-semibold text-12px lg:text-17px font-poppins leading-4 lg:leading-6 mb-1">Proses dan progress eksport dan import bisa dipantau dari mana saja</p>
                                <p class="text-11px lg:text-17px font-poppins text-[#707070] leading-5 lg:leading-6">
                                    Hanya perlu jaringan internet, Anda bisa memantau progress eksport ataupun import Anda dari manapun dan kapanpun</p>
                            </div>
                        </div> --}}
                    </div>
                    <div class="w-full lg:w-[54%] lg:pt-10 pt-2">
                        <img src="{{ uri( ordefault($meta->export_import_feature_main_image, 'assets/fl/thumb-multi.png'))}}" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="w-full h-full">
            <div class="container">
                <div class="flex justify-between mb-6 items-center px-4 lg:hidden">
                    ...
                    <div class="flex flex-col items-center gap-2">
                        <img src="{{ asset('assets/fl/tab-2.png')}}" alt="" class="h-24px">
                        <span class="text-14px font-poppins font-semibold text-center leading-5">{{ ordefault($meta->procurement_feature_tab_title, 'Digitalisasi Procurement') }}</span>
                    </div>
                    <img src="{{ asset('assets/fl/tab-arrow.png')}}" alt="" @click="current++">
                </div>
                <div class="flex lg:flex-row flex-col-reverse gap-4 lg:gap-12">
                    <div class="w-full lg:w-[45%] px-2">
                        <h3 class="text-18px lg:text-27px lg:leading-9 leading-6 font-poppins font-medium mb-4 lg:mb-10">{{ ordefault($meta->procurement_feature_tab_title, 'Digitalisasi Procurement') }}</h3>
                        @if (!empty($meta->procurement_selling_point))
                        @foreach ($meta->procurement_selling_point as $v)
                        <div class="flex gap-3 lg:gap-4 mb-3 lg:mb-8">
                            <div class="flex-shrink-0  w-5 aspect-square lg:w-auto"><img src="{{ asset('assets/fl/check-flower.png')}}" alt=""></div>
                            <div>
                                <p class="font-semibold text-12px lg:text-17px font-poppins leading-4 lg:leading-6 mb-1">{{ $v->procurement_selling_point_title }}</p>
                                <p class="text-11px lg:text-17px font-poppins text-[#707070] leading-5 lg:leading-6">
                                    {{ $v->procurement_selling_point_desc }}
                                </p>
                            </div>
                        </div>
                        @endforeach
                        ...
                        {{-- <div class="flex gap-3 lg:gap-4 mb-3 lg:mb-8">
                            <div class="flex-shrink-0  w-5 aspect-square lg:w-auto"><img src="{{ asset('assets/fl/check-flower.png')}}" alt=""></div>
                            <div>
                                <p class="font-semibold text-12px lg:text-17px font-poppins leading-4 lg:leading-6 mb-1">Kontrol pengadaan lebih mudah</p>
                                <p class="text-11px lg:text-17px font-poppins text-[#707070] leading-5 lg:leading-6">
                                    Pantau seluruh proses pengadaan dari berbagai divisi lewat satu aplikasi.</p>
                            </div>
                        </div>
                        <div class="flex gap-3 lg:gap-4 mb-3 lg:mb-8">
                            <div class="flex-shrink-0  w-5 aspect-square lg:w-auto"><img src="{{ asset('assets/fl/check-flower.png')}}" alt=""></div>
                            <div>
                                <p class="font-semibold text-12px lg:text-17px font-poppins leading-4 lg:leading-6 mb-1">Meminimalisasi terjadinya kesalahan</p>
                                <p class="text-11px lg:text-17px font-poppins text-[#707070] leading-5 lg:leading-6">
                                    Digitalisasi mengindari kesalahan proses atau penginputan karena human error karena seluruh proses procurement dilakukan secara digital</p>
                            </div>
                        </div>
                        <div class="flex gap-4">
                            <div class="flex-shrink-0  w-5 aspect-square lg:w-auto"><img src="{{ asset('assets/fl/check-flower.png')}}" alt=""></div>
                            <div>
                                <p class="font-semibold text-12px lg:text-17px font-poppins leading-4 lg:leading-6 mb-1">Biaya pembelanjaan lebih transparan</p>
                                <p class="text-11px lg:text-17px font-poppins text-[#707070] leading-5 lg:leading-6">
                                    Smart reportin membantu menghindari adanya kesalahan proses karena seluruh proses procurement terpantau secara realtime</p>
                            </div>
                        </div> --}}
                    </div>
                    <div class="w-full lg:w-[54%] lg:pt-10 pt-2">
                        <img src="{{ uri( ordefault($meta->procurement_feature_main_image, 'assets/fl/thumb-multi.png'))}}" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="flex justify-between mb-6 items-center px-4 lg:hidden">
                    ...
                    <div class="flex flex-col items-center gap-2">
                        ...
                        <span class="text-14px font-poppins font-semibold text-center leading-5">{{ ordefault($meta->visual_operational_feature_tab_title, 'Visualisai operasional secara realtime') }}</span>
                    </div>
                    <img src="{{ asset('assets/fl/tab-arrow.png')}}" alt="" style="filter:grayscale(1)">
                </div>
                <div class="flex lg:flex-row flex-col-reverse gap-4 lg:gap-12">
                    <div class="w-full lg:w-[45%] px-2">
                        <h3 class="text-18px lg:text-27px lg:leading-9 leading-6 font-poppins font-medium mb-4 lg:mb-10">{{ ordefault($meta->visual_operational_feature_tab_title, 'Visualisai operasional secara realtime') }}
                        </h3>
                        ...
                        {{-- <div class="flex gap-3 lg:gap-4 mb-3 lg:mb-8">
                            <div class="flex-shrink-0  w-5 aspect-square lg:w-auto"><img src="{{ asset('assets/fl/check-flower.png')}}" alt=""></div>
                            <div>
                                <p class="font-semibold text-12px lg:text-17px font-poppins leading-4 lg:leading-6 mb-1">Lacak proses operasional bisnis dengan mudah</p>
                                <p class="text-11px lg:text-17px font-poppins text-[#707070] leading-5 lg:leading-6">
                                    Progress operasional bisnis bisa dipantau lewat Visual-K</p>
                            </div>
                        </div>
                        <div class="flex gap-3 lg:gap-4 mb-3 lg:mb-8">
                            <div class="flex-shrink-0  w-5 aspect-square lg:w-auto"><img src="{{ asset('assets/fl/check-flower.png')}}" alt=""></div>
                            <div>
                                <p class="font-semibold text-12px lg:text-17px font-poppins leading-4 lg:leading-6 mb-1">Memantau kondisi yang terjadi di setiap proses bisnis secara realtime</p>
                                <p class="text-11px lg:text-17px font-poppins text-[#707070] leading-5 lg:leading-6">
                        ...
                        <div class="flex gap-4">
                            <div class="flex-shrink-0  w-5 aspect-square lg:w-auto"><img src="{{ asset('assets/fl/check-flower.png')}}" alt=""></div>
                            <div>
                                <p class="font-semibold text-12px lg:text-17px font-poppins leading-4 lg:leading-6 mb-1">Memudahkan pengambilan keputusan</p>
                                <p class="text-11px lg:text-17px font-poppins text-[#707070] leading-5 lg:leading-6">
                                    Ambil keputusan tepat dengan masalah yang teridentifikasi dengan cepat</p>
                            </div>
                        </div> --}}
                    </div>
                    <div class="w-full lg:w-[54%] lg:pt-10 pt-2">
                        <img src="{{ uri( ordefault($meta->visual_operational_feature_main_image, 'assets/fl/thumb-multi.png'))}}" alt="">
                    </div>
                </div>
            </div>
        </div>
...
<section class="py-8 lg:py-26">
    <div class="container pb-10">
        ...
        <p class="font-opensans text-11px lg:text-19px text-[#626B79] text-center lg:max-w-[56%] mx-auto leading-4 lg:leading-7">
            {{ ordefault($meta->screenshot_section_sub_titlem, 'AccounTax menyediakan fitur komprehensif yang memudahkan.') }}</p>
        <div class="w-full lg:w-[90%] mt-8 lg:mt-24 swiper prose-swiper">
            <div class="swiper-wrapper">
                ...
                {{-- <div class="!flex lg:flex-row flex-col prose swiper-slide">
                    <div class="w-full lg:w-[50%] flex items-center justify-center relative" >
                        <img src="{{ asset('assets/fl/prose-thumb-bg.png')}}" alt="" class="absolute prosebg">
                        <img src="{{ asset('assets/fl/i52.png')}}" alt="" class="relative proseimg">
                    </div>
                    <div class="w-[90%] lg:w-[50%] flex flex-col justify-center gap-1 lg:gap-4 prosetext mx-auto lg:ml-0" >
                        <h3 class="text-16px lg:text-30px font-poppins font-medium leading-6 lg:leading-10">
                            Optimalkan kegiatan inventaris di berbagai gudang</h3>
                        <p class="text-11px lg:text-19px font-opensans text-[#626B79] leading-4 lg:leading-7">
                            Dapatkan informasi mengenai jumlah stock dan notifikasi ketika barang sudah mencapai limit.</p>
                    </div>
                </div>
                <div class="!flex lg:flex-row flex-col prose swiper-slide">
                    <div class="w-full lg:w-[50%] flex items-center justify-center relative" >
                        <img src="{{ asset('assets/fl/prose-thumb-bg.png')}}" alt="" class="absolute prosebg">
                        <img src="{{ asset('assets/fl/i53.png')}}" alt="" class="relative proseimg">
                    </div>
                    <div class="w-[90%] lg:w-[50%] flex flex-col justify-center gap-1 lg:gap-4 prosetext mx-auto lg:ml-0" >
                        <h3 class="text-16px lg:text-30px font-poppins font-medium leading-6 lg:leading-10">Maksimalkan kegiatan ekspor impor dengan sistem ERP Trading & Distribution milik SystemEver</h3>
                        <p class="text-11px lg:text-19px font-opensans text-[#626B79] leading-4 lg:leading-7">
                            Siap digunakan dan selalu update dengan aturan yang berlaku di berbagai negara.</p>
                    </div>
                </div> --}}
            </div>
    ...
    <div class="flex justify-center gap-2 lg:gap-4 lg:pb-16">
        ...
        <a href="{{ ordefault($meta->demo_url, '#') }}" class="font-montserrat inline-flex items-center justify-center h-31px lg:h-48px px-4 lg:px-30px text-11px lg:text-16px  rounded-full bg-[#009944] text-white font-bold  hover:text-white">
            {{ ordefault($meta->see_more_button_label, 'Jadwalkan Demo') }}
        </a>
    ...
    <div class="container">
        <div class="flex lg:flex-row flex-col gap-4 lg:gap-12">
            <div class="w-full lg:w-[40%] px-2 lg:pt-16 pt-2">
                <img src="{{ asset('assets/fl/i5-img.png')}}" alt="" class="lg:ml-4 lg:mt-12 w-[40%] mx-auto lg:w-auto mb-4 lg:hidden block">
            ...
            <div class="w-full lg:w-[60%] grid grid-cols-2 gap-y-2 gap-x-6 lg:gap-x-8 px-4 lg:px-0  lg:gap-y-4">
                ...
                {{-- <div class="flex flex-col gap-3px lg:gap-6px py-4">
                    <div class="flex gap-2 lg:gap-4 items-center  mb-3 lg:mb-4">
                        <img src="{{ asset('assets/fl/i5-0-1.png')}}" alt="" class="lg:w-auto lg:h-auto object-contain w-6 h-6"><span class="text-11px lg:text-19px font-poppins font-semibold text-[#009944]">General Info</span>
                    </div>
                    <div class="flex gap-2 lg:gap-3 items-start">
                        <img src="{{ asset('assets/fl/check-small.png')}}" alt="" class="lg:mt-1 mt-[2px] lg:w-auto w-2">
                ...
                <div class="flex flex-col gap-3px lg:gap-6px py-4">
                    <div class="flex gap-2 lg:gap-4 items-center  mb-3 lg:mb-4">
                        <img src="{{ asset('assets/fl/i5-0-2.png')}}" alt="" class="lg:w-auto lg:h-auto object-contain w-6 h-6"><span class="text-11px lg:text-19px font-poppins font-semibold text-[#009944]">Accounting</span>
                    </div>
                    <div class="flex gap-2 lg:gap-3 items-start">
                        <img src="{{ asset('assets/fl/check-small.png')}}" alt="" class="lg:mt-1 mt-[2px] lg:w-auto w-2">
                ...
                <div class="flex flex-col gap-3px lg:gap-6px py-4">
                    <div class="flex gap-2 lg:gap-4 items-center  mb-3 lg:mb-4">
                        <img src="{{ asset('assets/fl/i5-0-3.png')}}" alt="" class="lg:w-auto lg:h-auto object-contain w-6 h-6"><span class="text-11px lg:text-19px font-poppins font-semibold text-[#009944]">Costing</span>
                    </div>
                    <div class="flex gap-2 lg:gap-3 items-start">
                        <img src="{{ asset('assets/fl/check-small.png')}}" alt="" class="lg:mt-1 mt-[2px] lg:w-auto w-2">
                ...
                <div class="flex flex-col gap-3px lg:gap-6px py-4">
                    <div class="flex gap-2 lg:gap-4 items-center  mb-3 lg:mb-4">
                        <img src="{{ asset('assets/fl/i5-0-4.png')}}" alt="" class="lg:w-auto lg:h-auto object-contain w-6 h-6"><span class="text-11px lg:text-19px font-poppins font-semibold text-[#009944]">Sales</span>
                    </div>
                    <div class="flex gap-2 lg:gap-3 items-start">
                        <img src="{{ asset('assets/fl/check-small.png')}}" alt="" class="lg:mt-1 mt-[2px] lg:w-auto w-2">
                ...
                <div class="flex flex-col gap-1 py-4">
                    <div class="flex gap-2 lg:gap-4 items-center  mb-3 lg:mb-4">
                        <img src="{{ asset('assets/fl/i5-0-5.png')}}" alt="" class="lg:w-auto lg:h-auto object-contain w-6 h-6"><span class="text-11px lg:text-19px font-poppins font-semibold text-[#009944]">Purchasing</span>
                    </div>
                    <div class="flex gap-2 lg:gap-3 items-start">
                        <img src="{{ asset('assets/fl/check-small.png')}}" alt="" class="lg:mt-1 mt-[2px] lg:w-auto w-2">
                ...
                <div class="flex flex-col gap-1 py-4"> --}}
                    <div class="flex gap-2 lg:gap-4 items-center  mb-3 lg:mb-4">
                        <img src="{{ asset('assets/fl/i5-0-6.png')}}" alt="" class="lg:w-auto lg:h-auto object-contain w-6 h-6"><span class="text-11px lg:text-19px font-poppins font-semibold text-[#009944]">Inventory</span>
                    </div>
                    <div class="flex gap-2 lg:gap-3 items-start">
                        <img src="{{ asset('assets/fl/check-small.png')}}" alt="" class="lg:mt-1 mt-[2px] lg:w-auto w-2">
...
<section class="pt-10 lg:pt-20">
    <div class="container" x-data="{
        brands:[
            '{{ asset('assets/fl/brand-bng.png')}}',
            '{{ asset('assets/fl/brand-inaa.png')}}',
            '{{ asset('assets/fl/brand-staindo.png')}}',
            '{{ asset('assets/fl/brand-qst.png')}}',
        ]
    }">
        <h2 class="text-center text-16px lg:text-29px font-bold font-montserrat text-[#444444] mb-8 lg:mb-16 leading-6">2000 + bisnis telah menggunakan ERP Trading & Distribution</h2>
            ...
            <div class="flex lg:gap-4   mx-auto " style="width: max-content" :class="brands.length > 6 ? 'track' : ''">
                ...
                <template x-for="brand in brands">
                    <div class="flex items-center justify-center h-36px lg:h-70px lg:p-4 p-2 aspect-mod2">
                        <img :src="brand" alt="" class="h-full">
                    </div>
                </template>
                </template>
            </div>
        ...
        <img src="{{ asset('assets/fl/testimoni.png')}}" alt="" class="absolute top-0 lg:-left-8 lg:w-auto w-[70%x]">
            ...
            <div class="w-full lg:w-[50%] pt-4 lg:pt-0">
                <div class="w-full lg:w-533px flex flex-col gap-4 lg:gap-6 ml-auto " x-data="{active:0}">
                    <div class="flex flex-col rounded-lg bg-white shadow-md overflow-hidden ">
                        <div class="px-4 lg:px-8 text-11px lg:text-19px font-medium font-poppins lg:leading-7 leading-4 min-h-47px lg:min-h-78px cursor-pointer  flex gap-4 items-center justify-between" :class="active==0?'bg-[#009944] font-bold text-white':''" @click="active=(active==0?null:0)">
                            Apa itu ERP Trading & Distribusi? <img src="{{ asset('assets/fl/faq-arrow.png')}}" alt="" class="h-9px w-18px" :class="active==0?'':'filter brightness-50 transform rotate-180'"></div>
                        <div class="px-4 lg:px-8 text-11px lg:text-17px transition-all font-poppins leading-4 lg:leading-6  " :class="active==0?'max-h-100 py-3 lg:py-4':'max-h-0 py-0 overflow-hidden'"> ERP Trading and Distribusi adalah aplikasi ERP yang diciptakan untuk memudahkan operasional bisnis trading dan distribusi</div>
                    </div>
                    <div class="flex flex-col rounded-lg bg-white shadow-md overflow-hidden ">
                        <div class="px-4 lg:px-8 text-11px lg:text-19px font-medium font-poppins lg:leading-7 leading-4 min-h-47px lg:min-h-78px cursor-pointer  flex gap-4 items-center justify-between" :class="active==1?'bg-[#009944] font-bold text-white':''" @click="active=(active==1?null:1)">
                            Siapa pengguna ERP Trading & Distribusi? <img src="{{ asset('assets/fl/faq-arrow.png')}}" alt="" class="h-9px w-18px" :class="active==1?'':'filter brightness-50 transform rotate-180'">
                        </div>
                        <div class="px-4 lg:px-8 text-11px lg:text-17px transition-all font-poppins leading-4 lg:leading-6  " :class="active==1?'max-h-100 py-3 lg:py-4':'max-h-0 py-0 overflow-hidden'">ERP Trading and Distribusi bisa digunakan oleh perusahaan yang bergerak di bidang trading dan distribusi di berbagai skala</div>
                    </div>
                    <div class="flex flex-col rounded-lg bg-white shadow-md overflow-hidden ">
                        <div class="px-4 lg:px-8 text-11px lg:text-19px font-medium font-poppins lg:leading-7 leading-4 min-h-47px lg:min-h-78px cursor-pointer  flex gap-4 items-center justify-between" :class="active==2?'bg-[#009944] font-bold text-white':''" @click="active=(active==2?null:2)">
                            Bagaimana keamanan data ERP Trading & Distribusi ? <img src="{{ asset('assets/fl/faq-arrow.png')}}" alt="" class="h-9px w-18px" :class="active==2?'':'filter brightness-50 transform rotate-180'">
                        </div>
                    ...
                    <div class="flex flex-col rounded-lg bg-white shadow-md overflow-hidden ">
                        <div class="px-4 lg:px-8 text-11px lg:text-19px font-medium font-poppins lg:leading-7 leading-4 min-h-47px lg:min-h-78px cursor-pointer  flex gap-4 items-center justify-between" :class="active==3?'bg-[#009944] font-bold text-white':''" @click="active=(active==3?null:3)">
                            Bagaimana saya menghubungi SystemEver? <img src="{{ asset('assets/fl/faq-arrow.png')}}" alt="" class="h-9px w-18px" :class="active==3?'':'filter brightness-50 transform rotate-180'">
                        </div>
