...
<section class="pt-10 lg:pt-20">
    <div class="container" x-data="{
        ...
        <h2 class="text-center text-16px lg:text-29px font-bold font-montserrat text-[#444444] mb-8 lg:mb-16 leading-6">{{ ordefault($meta->brand_list_title, '2000 + bisnis telah menggunakan ERP Trading & Distribution' ) }}</h2>
