...
<section class="py-8 lg:py-16">
    <div class="container">
        <div class="bc"><a href="/">{{ stringlang('Home', 'Beranda') }}</a><img src="{{asset('assets/fl/bc.png')}}" alt=""><a href="">{{ stringlang('Solution', 'Solusi') }}</a><img src="{{asset('assets/fl/bc.png')}}" alt=""><a href="" class="active">Business Management System (BMS)</a></div>
...
<section class="pt-8 lg:pt-16" x-data="{current:0}">
    <div class="container pb-5 lg:pb-10">
        <h2 class="text-20px lg:text-27px font-poppins font-medium text-center mb-3 lg:mb-6 leading-6 lg:leading-9 lg:w-[60%] mx-auto">
            {!!  str_replace( "#JadiLebihMudah", "<strong>#JadiLebihMudah</strong>", ordefault($meta->second_section_title, 'Mengelola dokumen perusahaan <br><strong>#JadiLebihMudah</strong> dengan BMS'))  !!}
        </h2>
        <p class="font-opensans text-11px lg:text-19px text-[#626B79] text-center lg:max-w-[50%] mx-auto leading-4 lg:leading-6">
            {{ $meta->second_section_sub_title }}
        <div class="justify-between w-full px-18 mt-16 hidden lg:flex">
            <div class="flex gap-4 items-center p-4 cursor-pointer relative" @click="current=0">
                <img src="{{ uri(ordefault($meta->management_data_main_icon,'assets/fl/tab-7.png'))}}" alt="" :class="current!=0?'filter grayscale-100':''">
                <span class="font-poppins text-18 font-semibold text-[#01010]">{{ ordefault($meta->management_data_tab_title, 'Management Data Client') }}</span>
            ...
            <div class="flex gap-4 items-center p-4 cursor-pointer relative" @click="current=1">
                <img src="{{ uri(ordefault($meta->invoice_tracking_feature_main_icon,'assets/fl/tab-8.png'))}}" alt="" :class="current!=1?'filter grayscale-100':''">
                <span class="font-poppins text-18 font-semibold text-[#01010]">{{ ordefault($meta->invoice_tracking_feature_tab_title, 'Pelacakan Penagihan dan Invoice') }}</span>
            ...
            <div class="flex gap-4 items-center p-4 cursor-pointer relative" @click="current=2">
                <img src="{{ uri(ordefault($meta->contract_management_feature_main_icon,'assets/fl/tab-3.png'))}}" alt="" :class="current!=2?'filter grayscale-100':''">
                <span class="font-poppins text-18 font-semibold text-[#01010]">{{ ordefault($meta->contract_management_feature_tab_title, 'Manajemen Kontrak') }}</span>
            ...
            <div class="container">
                <div class="flex justify-between mb-6 items-center px-4 lg:hidden">
                    ...
                    <div class="flex flex-col items-center gap-2">
                        <img src="{{ asset('assets/fl/tab-7.png')}}" alt="" class="h-24px">
                        <span class="text-14px font-poppins font-semibold">{{ ordefault($meta->management_data_tab_title, 'Management Data Client') }}</span>
                    </div>
                ...
                <div class="flex lg:flex-row flex-col-reverse gap-4 lg:gap-12">
                    <div class="w-full lg:w-[45%] px-2">
                        <h3 class="text-18px lg:text-27px font-poppins font-medium mb-4 lg:mb-10">{{ ordefault($meta->management_data_tab_title, 'Management Data Client') }}</h3>
                        @if (!empty($meta->management_data_selling_point))
                        @foreach ($meta->management_data_selling_point as $v)
                        <div class="flex gap-3 lg:gap-4 mb-3 lg:mb-8">
                            ...
                            <div>
                                <p class="font-semibold text-12px lg:text-17px font-poppins leading-4 lg:leading-6 mb-1">{{ $v->management_data_selling_point_title }}</p>
                                <p class="text-11px lg:text-17px font-poppins text-[#707070] leading-5 lg:leading-6">
                                    {{ $v->management_data_selling_point_desc }}
                                </p>
                            </div>
                        </div>
                        @endforeach
                    ...
                    <div class="w-full lg:w-[55%] lg:pt-10 pt-2">
                        <img src="{{ uri( ordefault($meta->management_data_main_image, 'assets/fl/thumb-bms.png'))}}" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="w-full h-full">
            <div class="container">
                <div class="flex justify-between mb-6 items-center px-4 lg:hidden">
                    ...
                    <div class="flex flex-col items-center gap-2">
                        <img src="{{ asset('assets/fl/tab-8.png')}}" alt="" class="h-24px">
                        <span class="text-14px font-poppins font-semibold">{{ ordefault($meta->invoice_tracking_feature_tab_title, 'Pelacakan Penagihan dan Invoice') }}</span>
                    </div>
                    <img src="{{ asset('assets/fl/tab-arrow.png')}}" alt="" @click="current++">
                </div>
                <div class="flex lg:flex-row flex-col-reverse gap-4 lg:gap-12">
                    <div class="w-full lg:w-[45%] px-2">
                        <h3 class="text-18px lg:text-27px font-poppins font-medium mb-4 lg:mb-10">{{ ordefault($meta->invoice_tracking_feature_tab_title, 'Pelacakan Penagihan dan Invoice') }}</h3>
                        @if (!empty($meta->invoice_tracking_selling_point))
                        @foreach ($meta->invoice_tracking_selling_point as $v)
                        <div class="flex gap-3 lg:gap-4 mb-3 lg:mb-8">
                            <div class="flex-shrink-0  w-5 aspect-square lg:w-auto"><img src="{{ asset('assets/fl/check-flower.png')}}" alt=""></div>
                            <div>
                                <p class="font-semibold text-12px lg:text-17px font-poppins leading-4 lg:leading-6 mb-1">{{ $v->invoice_tracking_selling_point_title }}</p>
                                <p class="text-11px lg:text-17px font-poppins text-[#707070] leading-5 lg:leading-6">
                                    {{ $v->invoice_tracking_selling_point_desc }}
                                </p>
                            </div>
                        </div>
                        @endforeach
                    ...
                    <div class="w-full lg:w-[55%] lg:pt-10 pt-2">
                        <img src="{{ uri( ordefault($meta->invoice_tracking_feature_main_image, 'assets/fl/thumb-bms.png'))}}" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="flex justify-between mb-6 items-center px-4 lg:hidden">
                    ...
                    <div class="flex flex-col items-center gap-2">
                        ...
                        <span class="text-14px font-poppins font-semibold">{{ ordefault($meta->contract_management_feature_tab_title, 'Manajemen Kontrak') }}</span>
                    </div>
                    <img src="{{ asset('assets/fl/tab-arrow.png')}}" alt="" style="filter:grayscale(1)">
                </div>
                <div class="flex lg:flex-row flex-col-reverse gap-4 lg:gap-12">
                    <div class="w-full lg:w-[45%] px-2">
                        <h3 class="text-18px lg:text-27px font-poppins font-medium mb-4 lg:mb-10">{{ ordefault($meta->contract_management_feature_tab_title, 'Manajemen Kontrak') }}
                        </h3>
                        @if (!empty($meta->contract_management_selling_point))
                        @foreach ($meta->contract_management_selling_point as $v)
                        <div class="flex gap-3 lg:gap-4 mb-3 lg:mb-8">
                            <div class="flex-shrink-0  w-5 aspect-square lg:w-auto"><img src="{{ asset('assets/fl/check-flower.png')}}" alt=""></div>
                            <div>
                                <p class="font-semibold text-12px lg:text-17px font-poppins leading-4 lg:leading-6 mb-1">{{ $v->contract_management_selling_point_title }}</p>
                                <p class="text-11px lg:text-17px font-poppins text-[#707070] leading-5 lg:leading-6">
                                    {{ $v->contract_management_selling_point_desc }}
                                </p>
                            </div>
                        </div>
                        @endforeach
                    ...
                    <div class="w-full lg:w-[55%] lg:pt-10 pt-2">
                        <img src="{{ uri( ordefault($meta->contract_management_feature_main_image, 'assets/fl/thumb-bms.png'))}}" alt="">
                    </div>
                </div>
            </div>
        </div>
...
<section class="py-8 lg:py-16">
    <div class="container pb-10">
        ...
        <div class="w-full lg:w-[90%] mt-4 lg:mt-16 swiper prose-swiper">
    ...
    <div class="container">
        <div class="flex lg:flex-row flex-col gap-4 lg:gap-12">
            <div class="w-full lg:w-[40%] px-2 lg:pt-16 pt-2">
                <img src="{{ asset('assets/fl/bms-img-1.png')}}" alt="" class="lg:ml-4 lg:mt-12 w-[40%] mx-auto lg:w-auto mb-4 lg:hidden block">
                ...
                <img src="{{ uri(ordefault($meta->feature_checklist_image, 'assets/fl/bms-img-1.png'))}}" alt="" class="lg:ml-4 lg:mt-12 w-[40%] mx-auto lg:w-auto mb-4 hidden lg:block">
            </div>
            @php
            $i = 0;
            $features = [];
...
<!-- <section class="pt-10 lg:pt-20">
    <div class="container" x-data="{
        ...
        <h2 class="text-center text-16px lg:text-29px font-bold font-montserrat text-[#444444] mb-8 lg:mb-16 leading-6">2000 bisnis telah menggunakan BMS</h2>
