    ...
    <div class="payroll-container">
        ...
        <div class="payroll-hero-grid">
            <div>
                ...
                <h1>{{ stringlang('Payroll Management', 'Payroll Manajemen', '급여관리 시스템') }}</h1>
                
                <p>{{ stringlang('A payroll management system that'
                                , 'Sistem manajemen payroll yang secara'
                                , '복잡한 급여 구조와 인사 변동까지'
                                ) }}
                                <br> 
                    {{ stringlang('automatically handles complex payroll'
                                , 'otomatis menangani struktur gaji yang'
                                , '자동으로 처리하는 스마트 급여 관리 시스템'
                                ) }}
                    @if(activelang() != 'KOR')
                                <br>
                    {{ stringlang('structures and HR changes'
                                , 'kompleks dan perubahan data HR.'
                                ) }}
                    @endif
                            </p>
            </div>
        ...
        <div style="margin-top: 40px; text-align: center;">
            @if(activelang() == 'KOR')
                <img src="{{ asset('assets/img/payroll-desc-kor.png') }}" alt="Payroll Description" style="width: 100%; max-width: 100%; height: auto;">
            @elseif(activelang() == 'ID')
                <img src="{{ asset('assets/img/payroll-desc-ind.png') }}" alt="Payroll Description" style="width: 100%; max-width: 100%; height: auto;">
            @else
                <img src="{{ asset('assets/img/payroll-desc-eng.png') }}" alt="Payroll Description" style="width: 100%; max-width: 100%; height: auto;">
            @endif
        </div>
...
<section class="payroll-features">
    <div class="payroll-container">
        ...
        <div style="margin-top: 40px; text-align: center;">
            @if(activelang() == 'KOR')
                <img src="{{ asset('assets/img/payroll-feature-kor.png') }}" alt="Payroll Special Features" style="width: 100%; max-width: 100%; height: auto;">
            @elseif(activelang() == 'ID')
                <img src="{{ asset('assets/img/payroll-feature-ind.png') }}" alt="Fitur Khusus SystemEver Payroll" style="width: 100%; max-width: 100%; height: auto;">
            @else
                <img src="{{ asset('assets/img/payroll-feature-eng.png') }}" alt="Payroll Special Features" style="width: 100%; max-width: 100%; height: auto;">
            @endif
        </div>
...
<section class="payroll-main-features">
    <div class="payroll-container">
        <div style="margin-top: 40px; text-align: center;">
            @if(activelang() == 'KOR')
                <img src="{{ asset('assets/img/payroll-footnote-kor.png') }}" alt="Payroll Summarize" style="width: 100%; max-width: 100%; height: auto;">
            @elseif(activelang() == 'ID')
                <img src="{{ asset('assets/img/payroll-footnote-ind.png') }}" alt="Payroll Summarize" style="width: 100%; max-width: 100%; height: auto;">
            @else
                <img src="{{ asset('assets/img/payroll-footnote-eng.png') }}" alt="Payroll Summarize" style="width: 100%; max-width: 100%; height: auto;">
            @endif
        </div>
