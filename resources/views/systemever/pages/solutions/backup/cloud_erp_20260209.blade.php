...
@section('content')
<section class={{ activelang() === 'ID' ? "cloud-hero-id" : "cloud-hero" }}>
    <div class="cloud-container">
        <div class="cloud-hero-grid">
            <div data-aos="fade-right">
                <!-- <h1>{{ stringlang('Integrated ERP', 'Solusi ERP Terintegrasi', '지속 가능한 성장을') }}
                    <br>{{ stringlang('Solutions for Sustainable', 'untuk Pertumbuhan', '위한 통합 ERP 솔루션') }}
                    
                    @if(activelang() != 'KOR')
                        <br>{{ stringlang('Business Growth', 'Bisnis Berkelanjutan') }}
                    @endif
                </h1> -->
                <h1>{{ stringlang('Cloud ERP That Powers Growth', 'Cloud ERP untuk Mendorong Pertumbuhan Bisnis', '비즈니스 성장을 이끄는 클라우드 ERP') }}
                    <br>{{ stringlang('— Faster, Smarter, Simpler', '— Lebih Cepat, Lebih Cerdas, Lebih Sederhana', '— 더 빠르게, 더 스마트하게, 더 간편하게') }}
                </h1>
                <!-- <p> {{ stringlang('End-to-end enterprise solutions designed to streamline', 'Solusi bisnis end-to-end yang dirancang', '기업 전반의 업무를 하나의 흐름으로 연결하여') }}
                    <br>{{ stringlang('to streamline operations, improve visibility,', 'untuk mengoptimalkan operasional,', '운영 효율을 높이고, 데이터 가시성을 강화하며,') }}
                    <br>{{ stringlang('and support long-term business scalability', 'meningkatkan transparansi, dan mendukung', '중·장기적인 비즈니스 확장을 안정적으로 지원합니다.') }}
                    @if(activelang() == 'ID')
                        <br>skalabilitas bisnis jangka panjang.
                    @endif
                </p> -->
                <p> {{ stringlang('Manage Accounting, Inventory, Sales, Production, and Purchase in one secure, cloud platform'
                                ...
                                , '안전하고 통합된 하나의 클라우드 플랫폼에서 회계, 재고, 영업, 생산, 구매를 모두 관리하세요.') }}
                </p>
                <span> {{ stringlang('No heavy infrastructure. Fast deployment. Scalable by design.'
                                   ...
                                   , '복잡한 인프라는 필요 없습니다. 빠른 구축. 비즈니스 성장에 맞춰 유연하게 확장되도록 설계되었습니다.') }}</span>
...
<section class="key-benefit-section" style="padding-bottom: 0;">
    <!-- <div class="cloud-container">
        <h2 class="key-benefit-title">
        @if(activelang() == 'KOR')
            SystemEver ERP는 업무 환경에 맞게 <span>유연하게 적용</span> 유연하게 적용 가능한
        @elseif(activelang() == 'ID')
            SystemEver ERP dirancang agar, <span>fleksibel</span>, <span>mudah digunakan</span>, dan siap mengikuti kebutuhan bisnis yang terus berkembang.
        @else
            Our ERP Solutions, SystemEver and CloudAce, are <span>fleksibel</span> and <span>easy to use</span>
        @endif
        </h2>
    </div> -->
    <!-- <div class="cloud-container">
    ...
    <div class="cloud-container">
        <h2 class="key-benefit-title"><span>Why Choose SystemEver ERP / CloudAce ERP</span></h2>
    </div>
    <div style="width: 100%; max-width: 1600px; margin: 0 auto; padding: 0 20px; text-align: center;">
        <div class="key-benefit-box" data-aos="fade-up" style="background: none; padding: 0; box-shadow: none; display: block;">
            <img src="{{ asset('assets/img/cloud-keybenefit.png') }}" alt="Cloud ERP Benefits" style="width: 85%; border-radius: 20px; margin: 0 auto; display: block;">
            <!-- @if(activelang() == 'KOR')
                <img src="{{ asset('assets/img/cloud-keybenefit-kor.png') }}" alt="Cloud ERP Benefits" style="width: 85%; border-radius: 20px; margin: 0 auto; display: block;">
            @elseif(activelang() == 'ID')
                <img src="{{ asset('assets/img/cloud-keybenefit-ind.png') }}" alt="Cloud ERP Benefits" style="width: 85%; border-radius: 20px; margin: 0 auto; display: block;">
            @else
                <img src="{{ asset('assets/img/cloud-keybenefit-eng.png') }}" alt="Cloud ERP Benefits" style="width: 85%; border-radius: 20px; margin: 0 auto; display: block;">
            @endif -->
        </div>
    </div>
</section>
...
<section class="total-solutions">
    <div class="cloud-container">
        ...
        <div style="text-align: center;">
            @if(activelang() == 'KOR')
                <img src="{{ asset('assets/img/cloud-solution-kor.png') }}" alt="Total Solutions" style="width: 85%; max-width: 1020px; margin: 0 auto; display: block;">
            @else
                <img src="{{ asset('assets/img/cloud-solution.png') }}" alt="Total Solutions" style="width: 85%; max-width: 1020px; margin: 0 auto; display: block;">
            @endif
        </div>
    </div>
</section>
...
<section class="comparison-section" style="padding: 60px 0; background: #f8f9fa;">
    <div class="cloud-container" style="text-align: center;">
        @if(activelang() == 'KOR')
            <img src="{{ asset('assets/img/cloud-comparison-kor.png') }}" alt="CloudAce VS SystemEver Comparison" style="width: 85%; max-width: 1020px; border-radius: 10px; margin: 0 auto; display: block;">
        @elseif(activelang() == 'ID')
            <img src="{{ asset('assets/img/cloud-comparison-ind.png') }}" alt="CloudAce VS SystemEver Comparison" style="width: 85%; max-width: 1020px; border-radius: 10px; margin: 0 auto; display: block;">
        @else
            <img src="{{ asset('assets/img/cloud-comparison-eng.png') }}" alt="CloudAce VS SystemEver Comparison" style="width: 85%; max-width: 1020px; border-radius: 10px; margin: 0 auto; display: block;">
        @endif
    </div>
</section>
...
<section class="integration-section" style="padding: 80px 0; background: #f8f9fa;">
    <div class="cloud-container">
        ...
        <div style="text-align: center; margin-top: 40px;">
            @if(activelang() == 'KOR')
                <img src="{{ asset('assets/img/cloud-itinventory-kor.png') }}" alt="IT Inventory" style="width: 85%; max-width: 1020px; border-radius: 10px; margin: 0 auto; display: block;">
            @elseif(activelang() == 'ID')
                <img src="{{ asset('assets/img/cloud-itinventory-ind.png') }}" alt="IT Inventory" style="width: 85%; max-width: 1020px; border-radius: 10px; margin: 0 auto; display: block;">
            @else
                <img src="{{ asset('assets/img/cloud-itinventory-eng.png') }}" alt="IT Inventory" style="width: 85%; max-width: 1020px; border-radius: 10px; margin: 0 auto; display: block;">
            @endif
        </div>
