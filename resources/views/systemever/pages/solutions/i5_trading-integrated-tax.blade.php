...
<section class="pt-8 lg:pt-16" x-data="{current:0}">
    <div class="container pb-5 lg:pb-10">
        <h2 class="text-20px lg:text-27px font-poppins font-medium text-center mb-3 lg:mb-6  leading-6 lg:leading-9">
            {!!  str_replace( ordefault($meta->second_section_title, 'Kontrol bisinis #JadiLebihMudah dengan SystemEver'), "#JadiLebihMudah", "<strong>#JadiLebihMudah</strong>")  !!}
        </h2>
        ...
        <div class="justify-between w-full px-12 mt-16 hidden lg:flex">
            <div class="flex gap-4 items-center p-4 cursor-pointer relative" @click="current=0">
                <img src="{{ asset('assets/fl/tab-1.png')}}" alt="" :class="current!=0?'filter grayscale-100':''">
                <span class="font-poppins text-18 font-semibold text-[#01010]">Inventory multigudang</span>
            ...
            <div class="flex gap-4 items-center p-4 cursor-pointer relative" @click="current=1">
                <img src="{{ asset('assets/fl/tab-2.png')}}" alt="" :class="current!=1?'filter grayscale-100':''">
            ...
            <div class="flex gap-4 items-center p-4 cursor-pointer relative" @click="current=2">
                <img src="{{ asset('assets/fl/tab-4.png')}}" alt="" :class="current!=2?'filter grayscale-100':''">
                <span class="font-poppins text-18 font-semibold text-[#01010]">Digitalisasi Procurement</span>
            ...
            <div class="container">
                <div class="flex justify-between mb-6 items-center px-4 lg:hidden">
                    ...
                    <div class="flex flex-col items-center gap-2">
                        ...
                        <span class="text-14px font-poppins font-semibold text-center leading-5">Inventory multigudang</span>
                    </div>
                ...
                <div class="flex lg:flex-row flex-col-reverse gap-4 lg:gap-12">
                    <div class="w-full lg:w-[45%] px-2">
                        <h3 class="text-18px lg:text-27px lg:leading-9 leading-6 font-poppins font-medium mb-4 lg:mb-10">Inventory multigudang</h3>
                        <div class="flex gap-3 lg:gap-4 mb-3 lg:mb-8">
                            ...
                            <div>
                                <p class="font-semibold text-12px lg:text-17px font-poppins leading-4 lg:leading-6 mb-1">Pantau persediaan barang di berbagai gudang</p>
                                <p class="text-11px lg:text-17px font-poppins text-[#707070] leading-5 lg:leading-6">
                                    Lacak jumlah barang masuk dan keluar di berbagai gudang lewat satu aplikasi.</p>
                            </div>
                        </div>
                        <div class="flex gap-3 lg:gap-4 mb-3 lg:mb-8">
                            <div class="flex-shrink-0  w-5 aspect-square lg:w-auto"><img src="{{ asset('assets/fl/check-flower.png')}}" alt=""></div>
        ...
        <div class="w-full h-full">
            <div class="container">
                <div class="flex justify-between mb-6 items-center px-4 lg:hidden">
                    ...
                    <div class="flex flex-col items-center gap-2">
                        <img src="{{ asset('assets/fl/tab-2.png')}}" alt="" class="h-24px">
                        <span class="text-14px font-poppins font-semibold text-center leading-5">Digitalisasi Procurement</span>
                    </div>
                    <img src="{{ asset('assets/fl/tab-arrow.png')}}" alt="" @click="current++">
                </div>
                <div class="flex lg:flex-row flex-col-reverse gap-4 lg:gap-12">
                    <div class="w-full lg:w-[45%] px-2">
                        <h3 class="text-18px lg:text-27px lg:leading-9 leading-6 font-poppins font-medium mb-4 lg:mb-10">Digitalisasi Procurement</h3>
                        <div class="flex gap-3 lg:gap-4 mb-3 lg:mb-8">
                            <div class="flex-shrink-0  w-5 aspect-square lg:w-auto"><img src="{{ asset('assets/fl/check-flower.png')}}" alt=""></div>
                            <div>
...
<section class="py-8 lg:py-26">
    <div class="container pb-10">
        <h2 class="text-20px lg:text-27px font-poppins font-medium text-center mb-3 lg:mb-6 leading-6 lg:leading-9  lg:px-40">Kontrol proses bisnis mulai dari keuangan, inventaris, dan akuntansi secara real-time</h2>
            ...
            <div class="swiper-wrapper">
                <div class="!flex lg:flex-row flex-col prose swiper-slide">
                    <div class="w-full lg:w-[50%] flex items-center justify-center relative" >
                        ...
                        <img src="{{ asset('assets/fl/i51.png')}}" alt="" class="relative proseimg">
                    </div>
                    <div class="w-[90%] lg:w-[50%] flex flex-col justify-center gap-1 lg:gap-4 prosetext mx-auto lg:ml-0" >
                        <h3 class="text-16px lg:text-30px font-poppins font-medium leading-6 lg:leading-10">Hindari adanya kesalahan saat proses distribusi</h3>
                        <p class="text-11px lg:text-19px font-opensans text-[#626B79] leading-4 lg:leading-7">Adanya Early Warning System saat terjadi kesalahan dalam proses bisnis.</p>
                    </div>
                </div>
                <div class="!flex lg:flex-row flex-col prose swiper-slide">
                    <div class="w-full lg:w-[50%] flex items-center justify-center relative" >
    ...
    <div class="flex justify-center gap-2 lg:gap-4 lg:pb-16">
        <a href="" class="font-montserrat inline-flex items-center justify-center h-31px lg:h-48px px-4 lg:px-30px text-11px lg:text-16px  rounded-full bg-transparent text-[#009944] font-bold border border-[#009944] hover:bg-[#009944] hover:text-white">Whatsapp
            Kami</a>
        <a href="" class="font-montserrat inline-flex items-center justify-center h-31px lg:h-48px px-4 lg:px-30px text-11px lg:text-16px  rounded-full bg-[#009944] text-white font-bold  hover:text-white">Jadwalkan
            Demo</a>
        ...
        <div class="flex lg:flex-row flex-col gap-4 lg:gap-12">
            <div class="w-full lg:w-[40%] px-2 lg:pt-16 pt-2">
                ...
                <h2 class="text-17px lg:text-29px font-medium font-poppins leading-6 lg:leading-9 mb-2 lg:mb-4  lg:text-left text-center">
                    ERP Trading & Distribution</h2>
                <p class="text-[#626B79] font-opensans text-11px lg:text-19px leading-4 lg:leading-7 lg:max-w-[370px] lg:text-left text-center">
                    Dikembangkan untuk memberikan kemudahan dalam mengelola aktifitas bisnis Trading dan Distribusi.</p>

                <img src="{{ asset('assets/fl/i5-img.png')}}" alt="" class="lg:ml-4 lg:mt-12 w-[40%] mx-auto lg:w-auto mb-4 hidden lg:block">
            </div>
