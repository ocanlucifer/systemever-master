...
<div class="container">
    <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-12 col-12">
            ...
            <section class="section-detail-article mb-lg-5 mb-md-5 mb-4">
                <div class="title-detail-article mb-4 row-mb">
                    <img src="{{ asset_to_webp(uri($data->featured_image)) }}" alt="{{$data->title}}">
                ...
                <ul class="list-unstyled share-article d-flex justify-content-start align-items-center">
                   ...
                   <li><i class="fa fa-eye"></i> Views {{ nominal($data->views) }}</li>
                </ul>
            </section>
                    ...
                    @foreach ($related as $v)
                        <div class="item">
                            <div class="content-article listing">
                                <img src="{{ asset_to_webp(uri($v->featured_image)) }}" alt="{{$v->title}}">
        ...
        <div class="col-lg-4 pl-4">
            <div class="d-lg-block d-md-block d-sm-none d-none">
                @include('systemever/pages/article/includes/article_list_side', ['list' => $related])
            </div>
            @include('systemever/pages/article/includes/article_most_view', ['popular' => $popular])
        </div>
    </div>
</div>
