              ...
              <div class="row mb-3">
                <div class="col-lg-12">
                  <div class="find-by text-center">
                    @if (activelang() == "ID")
                    <h1 class="child-title ct-1">Dapat ditemukan di</h1>
                    @else 
                    <h1 class="child-title ct-1">Find here</h1>
                    @endif
                  </div>
                </div>
              </div>
              <div class="row d-flex justify-content-center row-min-7 mb-3">
                <div class="col-lg-5 padding-min-7 mb-3">
                  <a href="" class="link-marketplace rounded modal-tokopedia">
                    <img src="{{ asset('assets/img/tokopedia.svg') }}" alt="">
                  </a>
                </div>
                <div class="col-lg-5 padding-min-7 mb-3">
                  <a href="" class="link-marketplace rounded modal-shopee">
