                ...
                <div class="box-cart-wa">
                    <div class="item-box">
                        <ul class="list-unstyled d-flex">
                            ...
                            <li class="cart d-flex align-items-center"><a href=""><img src="{{ asset('assets/img/cart.svg') }}" alt=""></a></li>
                            <li class="pr-1"><a href=""><img src="{{ asset('assets/img/shopee-icon.svg') }}" alt=""></a></li>
                            <li class="pl-1"><a href=""><img src="{{ asset('assets/img/tokped-icon.svg') }}" alt=""></a></li>
                        </ul>
                    </div>
