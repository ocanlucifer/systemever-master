      ...
      <div class="modal-content">
        <div class="modal-header border-bottom-0 pb-0">
          <div class="modal-title pt-4 mt-lg-2 mt-md-2 mt-0 pl-lg-4 pl-md-4 pl-0 ml-2">
                ...
                <h5>Share your details and we’ll contact you <br> shortly.</h5>
          </div>
        ...
        <form action="">
            ...
            <div class="modal-footer border-top-0 d-block mb-5">
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8"><button type="submit" class="btn btn-white-orange w-100 btn-submit-modal">{{ stringlang('Submit', 'Kirim') }}</button></div>
                </div>
            </div>
        </form>
      </div>
