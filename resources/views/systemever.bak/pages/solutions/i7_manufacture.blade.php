...
<style>
.desc-erp-item ul {
    list-style-image: url('{{ asset_to_webp(uri('assets/img/Vector.svg')) }}');
...
<section class="section-banner-full position-relative">
    <img src="{{ asset_to_webp(uri($data->banner_image)) }}" alt="{{$data->banner_title}}">
                ...
                <div class="col-lg-5 pt-lg-5 pt-md-5 pt-sm-3 pt-4 pl-lg-5 px-4">
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-5 col-sm-6 col-6 pr-lg-3 pr-md-3 pr-sm-2 pr-2">
                            <a href="{{ route('get.pages.pricing.integrated_erp') }}#pricing-i7"><button class="btn-oval btn-view-detail btn-white-green mb-lg-4 w-100">{{ stringlang("Check Price", "Cek Harga") }}</button></a>
                        </div>
    ...
    <div class="container-content">
        ...
        <div class="row d-flex justify-content-center align-items-center mb-5">
           <div class="col-lg-11 d-flex justify-content-center align-items-center">
               ...
               <div class="title cl-blue">{{ stringlang('i7 INTEGRATED MANUFACTURING', 'SystemEver i7 Sistem ERP Manufaktur') }}</div>
               <div class="line-title bg-blue"></div>
           </div>
        </div>
    ...
    <div class="container">
        <div class="row d-flex justify-content-center py-lg-5 py-md-5 py-sm-3 py-3">
            <div class="col-lg-12 text-center">
                <h2>{{ stringlang('Who Need It?', 'Siapa yang Membutuhkan SystemEver i7 ERP Manufaktur?')}} </h2>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center mb-lg-5 mb-md-5 mb-sm-3 mb-3">
                <h2>{{ stringlang('Applicable Industries', 'Industri yang dapat menggunakan SystemEver i7 ERP Manufaktur') }}</h2>
            </div>
        </div>
        <div class="row i7-aplicable row-min-7-mb">
            ...
            <div class="col-md-4 i7-list-aplicable col-sm-4 col-4 mb-lg-5 mb-md-5 mb-sm-3 mb-3 padding-min-7-mb d-flex justify-content-lg-center justify-content-md-center justify-content-start">
                <div class="item-industry i7 d-lg-flex d-md-flex d-sm-block d-block justify-content-start px-lg-3 px-md-3 px-1 align-items-center">
                    <img class="mb-4 mb-md-4 mb-sm-2 mb-2" src="{{ asset_to_webp(url_to_svg(uri($v->main_image))) }}" alt="">
                    <div class="desc-item">
                        {!! $v->description !!}
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-12 text-center px-5">
                <a href="{{ route('get.pages.pricing.integrated_erp') }}#pricing-i7"><button type="button" class="btn-oval btn-view-detail btn-white-orange ">{{ stringlang("Check Price", "Cek Harga") }}</button></a>
            </div>
        </div>
    </div>
</section>
