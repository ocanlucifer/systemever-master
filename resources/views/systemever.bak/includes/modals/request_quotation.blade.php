<div class="modal modal-form fade" id="modal-request-quotation" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header border-bottom-0 pb-0">
          <div class="modal-title pt-4 mt-2 pl-4 ml-2">
                <h3>{{ stringlang('Request Quotation', 'Buat Penawaran') }} </h3>
                <h5>{!! stringlang('Share your details and we’ll contact you <br> shortly.', 
                'Share detail contact anda dan kita akan menghubungi anda segera') !!}</h5>
          </div>
        ...
        <div class="modal-body pb-0 px-5">
            <form action="{{ route('post.form.submit') }}" method="post" id="request_quotation_form">
                @csrf
              ...
              <div class="form-group">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <input type="hidden" name="type" value="request quotation">
                        <input type="hidden" name="from" value="{{ \URL::full() }}">
                        <button type="submit" class="submitme_request_quotation_form" style="display:none"></button>
                    </div>
                </div>
        ...
        <div class="modal-footer border-top-0 d-block mb-5">
            <div class="row d-flex justify-content-center">
                <div class="col-lg-8"><button type="button" class="btn btn-white-orange w-100 btn-submit-modal" onclick="$('.submitme_request_quotation_form').click()">{{ stringlang('Submit', 'Kirim') }}</button></div>
            </div>
...
@section('modal_js_quotation')
@include('systemever/includes/modals/modal_form_js', ['pointer' => 'request_quotation_form'])
@endsection