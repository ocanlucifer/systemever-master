      ...
      <div class="modal-content">
        <div class="modal-header border-bottom-0 pb-0">
          <div class="modal-title pt-4 mt-2 pl-4 ml-2">
              <h5>{{ stringlang('Take a coffee break with SystemEver', 'Mari rehat kopi dengan SystemEver') }}</h5>
              <h3>{{ stringlang("Request a Demo", "Mengajukan Demo") }}</h3>
          </div>
        ...
        <div class="modal-body pb-0 px-5">
            <form action="{{ route('post.form.submit') }}" method="post" id="request_demo_form">
                @csrf
              ...
              <div class="form-group">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <button type="submit" class="submitme_request_demo_form" style="display:none"></button>
                    </div>
                </div>
        ...
        <div class="modal-footer border-top-0 d-block mb-5">
            <div class="row d-flex justify-content-center">
                <div class="col-lg-8"><button type="button" class="btn btn-white-orange w-100 btn-submit-modal" onclick="$('.submitme_request_demo_form').click()">{{ stringlang('Submit', 'Kirim') }}</button></div>
            </div>
...
@section('modal_js_demo')
@include('systemever/includes/modals/modal_form_js', ['pointer' => 'request_demo_form'])
@endsection