          ...
          <li>
            <div class="card">
              ...
              <div id="collapse-solution" class="collapse" aria-labelledby="headingOne" data-parent="#accordionMenu">
                <div class="card-body">
                  <ul class="list-unstyled">
                    <li> <a href="{{ route('get.pages.solutions.index') }}">{{ stringlang('AccounTax', 'Layanan Akuntansi & Pajak') }}</a></li>
                    <li> <a href="{{ route('get.pages.solutions.bms') }}">{{ stringlang('SystemEver BMS', ' SystemEver BMS') }}</a></li>
